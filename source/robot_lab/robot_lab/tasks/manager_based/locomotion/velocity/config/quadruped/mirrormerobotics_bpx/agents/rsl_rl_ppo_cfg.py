...
@configclass
class MirrormeroboticBPXRoughPPORunnerCfg(RslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 50000
    save_interval = 100
    experiment_name = "mirrormerobotic_bpx_rough"
...
@configclass
class MirrormeroboticBPXFlatPPORunnerCfg(MirrormeroboticBPXRoughPPORunnerCfg):
    def __post_init__(self):
        super().__post_init__()

        self.max_iterations = 5000
        self.experiment_name = "mirrormerobotic_bpx_flat"


# @configclass
# class MirrormeroboticBPXStairPPORunnerCfg(RslRlOnPolicyRunnerCfg):
#     num_steps_per_env = 24
#     max_iterations = 50000
#     save_interval = 100
#     experiment_name = "mirrormerobotic_bpx_stair"
#     policy = RslRlPpoActorCriticCfg(
...
# @configclass
# class MirrormeroboticBPXParkourPPORunnerCfg(RslRlOnPolicyRunnerCfg):
#     num_steps_per_env = 24
#     max_iterations = 50000
#     save_interval = 100
#     experiment_name = "mirrormerobotic_bpx_parkour"
#     policy = RslRlPpoActorCriticCfg(
#         # The policy class name. Defaults to ActorCritic.
#         # REF: https://github.com/isaac-sim/IsaacLab/blob/f4aa17f87e2e5db5484f0b5974918573e8918ce2/source/isaaclab_rl/isaaclab_rl/rsl_rl/rl_cfg.py#L356
#         class_name="ActorCritic",
...
# @configclass
# class MirrormeroboticBPXGapPPORunnerCfg(RslRlOnPolicyRunnerCfg):
#     num_steps_per_env = 24
#     max_iterations = 50000
#     save_interval = 100
#     experiment_name = "mirrormerobotic_bpx_gap"
#     policy = RslRlPpoActorCriticCfg(
#         init_noise_std=1.0,
#         actor_obs_normalization=False,
#         critic_obs_normalization=False,
...
# @configclass
# class MirrormeroboticBPXRoughScanPPORunnerCfg(RslRlOnPolicyRunnerCfg):
#     num_steps_per_env = 24
#     max_iterations = 20000 # 모든 Abl 다 20000 통일
#     save_interval = 50
#     experiment_name = "mirrormerobotic_bpx_rough_scan"
...
# @configclass
# class MirrormeroboticBPXRoughAbl3_5PPORunnerCfg(MirrormeroboticBPXRoughScanPPORunnerCfg):
#     experiment_name = "mirrormerobotic_bpx_rough_scan_abl3_5"
